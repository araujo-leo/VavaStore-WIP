            ...
            <div class="card-body">
                ...
                <form id="cepForm" action="../inc/viacep.php" method="post">
                    ...
                    <div class="form-outline mb-4">
                        <input type="text" name="cep"  id="zipCode" class="form-control" placeholder="CEP" maxLength="9"
                            value="<?php 
                ...
                <form action="#" method="POST" id="delivery-form">
                    ...
                    <div class="form-row mb-4">
                        ...
                        <div class="form-group col-md-2">
                            <input type="text" name="numero" id="number" class="form-control" placeholder="Número" />
                        ...
                        <div class="card bg-primary text-white rounded-3">
                            <div class="card-body">
                                ...
                                <i class="fab fa-cc-diners-club fa-2x me-2  text-white"></i>
                                    ...
                                    <button type="submit" class="btn btn-info btn-block btn-lg" id="submit-button">
                                        <div class="d-flex justify-content-between">
